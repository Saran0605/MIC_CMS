...
<div class="sidebar" id="sidebar">
    ...
    <div class="menu">
        ...
        <div class="submenu">
            <a href="HR_leaveallocation" class="menu-item">
                <i class="fas fa-calendar-plus text-success"></i>
                <span>Leave Allocation</span>
            </a>
            <a href="HR_leaveapproval" class="menu-item">
                <i class="fas fa-check-circle text-primary"></i>
                <span>Leave Approval</span>
            </a>

            <a href="HR_atten" class="menu-item">
            <i class="fas fa-calendar-alt text-info"></i></i>
                <span>Attendance</span>
            </a>
            <a href="HR_report" class="menu-item">
                <i class="fas fa-file-alt text-danger"></i>
                <span>Report</span>
            </a>

            <a href="HR_holiday_allocation" class="menu-item">
            ...
            <a href="HR_others" class="menu-item">
