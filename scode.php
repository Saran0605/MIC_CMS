...
if (isset($_POST['update_basic'])) {
    ...
    $doadmission = mysqli_real_escape_string($db, $_POST['doadmission']);
    $admcate = mysqli_real_escape_string($db, $_POST['admcate']);
    $admtype = mysqli_real_escape_string($db, $_POST['admtype']);
    ...
    $socstrata = mysqli_real_escape_string($db, $_POST['socstrata']);
    $caste = mysqli_real_escape_string($db, $_POST['caste']);
    $nationality = mysqli_real_escape_string($db, $_POST['nationality']);
    $firstgra = mysqli_real_escape_string($db, $_POST['firstgra']);
    $eduloan = mysqli_real_escape_string($db, $_POST['eduloan']);
    $scholarship = mysqli_real_escape_string($db, $_POST['scholarship']);
    $scholartype = mysqli_real_escape_string($db, $_POST['scholartype']);
    $exam_status = mysqli_real_escape_string($db, $_POST['exam_status']);
    $exam_mark = mysqli_real_escape_string($db, $_POST['exam_mark']);
    $cutoff = mysqli_real_escape_string($db, $_POST['cutoff']);
    $mobile = mysqli_real_escape_string($db, $_POST['mobile']);
    $email = mysqli_real_escape_string($db, $_POST['email']);
    $offemail = mysqli_real_escape_string($db, $_POST['offemail']);
    $pmobile = mysqli_real_escape_string($db, $_POST['pmobile']);  
    $emis = mysqli_real_escape_string($db, $_POST['emis']);
    $umis = mysqli_real_escape_string($db, $_POST['umis']);
    ...
    $phyident1 = mysqli_real_escape_string($db, $_POST['phyident1']);
    $phyident2 = mysqli_real_escape_string($db, $_POST['phyident2']);
    ...
    $hosname = mysqli_real_escape_string($db, $_POST['hosname']);
    ...
    $guarname = mysqli_real_escape_string($db, $_POST['guarname']);
    $guarmobile = mysqli_real_escape_string($db, $_POST['guarmobile']);
    $guaraddress = mysqli_real_escape_string($db, $_POST['guaraddress']);
    ...
    $file_name4 = $_FILES['gphoto']['name'];
    $file_tmp4 = $_FILES['gphoto']['tmp_name'];
    $ext4 = pathinfo($file_name4, PATHINFO_EXTENSION);
    $file_name4 = $s . "." . $ext;

    $file_name5 = $_FILES['saadhar']['name'];
    $file_tmp5 = $_FILES['saadhar']['tmp_name'];
    $ext5 = pathinfo($file_name5, PATHINFO_EXTENSION);
    $file_name5 = $s . "." . $ext;

    $file_name6 = $_FILES['span']['name'];
    $file_tmp6 = $_FILES['span']['tmp_name'];
    ...
    $query = "SELECT pphoto,fphoto,mphoto,gphoto,saadhar,span FROM sbasic WHERE sid='$s'";
    $query_run = mysqli_query($db, $query);
    ...
    $filePath4 = "images/sguardian/" . $file_name4;
    $filePath5 = "images/saadhar/" . $file_name5;
    $filePath6 = "images/span/" . $file_name6;
    ...
    if (empty($errors) == true) {
        ...
        move_uploaded_file($file_tmp4, "images/sguardian/" . $file_name4);
        move_uploaded_file($file_tmp5, "images/saadhar/" . $file_name5);
        move_uploaded_file($file_tmp6, "images/span/" . $file_name6);




        $query = "UPDATE sbasic SET sid='$s',fname='$fname',lname='$lname',gender='$gender',programme='$programme',
        department='$department',doadmission='$doadmission',admcate='$admcate',admtype='$admtype', batch='$batch',dob='$dob',
        blood='$blood',religion='$religion',socstrata='$socstrata',caste='$caste',nationality='$nationality',firstgra='$firstgra',
        eduloan='$eduloan',scholarship='$scholarship',scholartype='$scholartype',exam_status='$exam_status',exam_mark='$exam_mark',
        cutoff='$cutoff',mobile='$mobile',email='$email',offemail='$offemail',pmobile='$pmobile',emis='$emis',umis='$umis',languages ='$languages',
        aadhar ='$aadhar',pan='$pan',phyident1='$phyident1',phyident2='$phyident1',hosday='$hosday',stay='$stay',busno='$busno',
        hosname='$hosname', room='$room',paddress='$paddress',taddress='$taddress',state='$state',city='$city',zip='$zip',country='$country',
        guarname='$guarname',guarmobile='$guarmobile',guaraddress='$guaraddress',pphoto='$filePath',fphoto='$filePath2', mphoto='$filePath3',
        gphoto='$filePath4',saadhar='$filePath5',span='$filePath5' WHERE sid='$s'";
        $query_run = mysqli_query($db, $query);
...
if (isset($_GET['student_Language'])) {
    $student_id = mysqli_real_escape_string($db, $_GET['student_Language']);

    $query = "SELECT * FROM slang WHERE id='$student_id'";
    $query_run = mysqli_query($db, $query);
