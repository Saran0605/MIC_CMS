    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <ul class="nav nav-tabs mb-3" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="manager-tab" data-bs-toggle="tab" href="#events" role="tab">

                        <i class="fa fa-id-card tab-icon"></i> Events
                    </a>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content tabcontent-border">
                ...
                <div class="tab-pane p-20" id="events" role="tabpanel">
                <?php include 'event_tabs.php'; ?>
