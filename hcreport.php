    ...
    <div class="container">
        <div class="header">
            ...
            <div class="date-input-container">
                ...
                <input type="date" id="date-input2" class="date-input">
                <button id="fetch-data" class="btn1">
        ...
        $(document).ready(function () {
            ...
            function createDepartmentCard(deptName, batches) {
                const batchesHtml = batches.map(batch => {
                    ...
                    return `
                        <div class="batch-row">
                            <div class="batch-name">Batch ${batch.ayear} ---> 
                              <button class="details-btn1" onclick="showMentorDetails('${deptName}', '${batch.ayear}', ${JSON.stringify(batch.mentors).replace(/"/g, '&quot;')})">
            ...
            function fetchData() {
                ...
                const selectedDate2 = $('#date-input2').val();
                if (!selectedDate) {
                ...
                $.ajax({
                    url: 'fetch_counseling_data_hod.php',
                    type: 'POST',
